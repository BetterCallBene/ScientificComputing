#define BOOST_TEST_MODULE MultiShooting Solver 
...
BOOST_AUTO_TEST_CASE(TestIntegratorRungeKutta)
{
	size_t n_intervals = 50;
	value_type g, m, kT, kQ, d, IM;
	value_type Iges[3] = {0, 0, 0};
	g = 0; m = 0; kT = 0; kQ = 0; d = 0; IM = 0;
	getInitialValues(&g, &m, &kT, &kQ, &d, &IM, Iges);
	cout << "---		--" << endl;
	cout << "Test: RungeKutta" << endl;
	cout << "Gravitation  g=" << g << endl;
	cout << "Masse        m=" << m << endl;
	cout << "            kT=" << kT <<endl;
	cout << "            kQ=" << kQ << endl;
	...
	solver::TestIntegratorRungeKutta(n_intervals, g, m, kT, kQ, d, IM, Iges);
	const clock_t end_time = clock();
	cout << float(end_time - begin_time) /  CLOCKS_PER_SEC << endl;
}
/*
BOOST_AUTO_TEST_CASE(TestIntegratorRosenbrock)
{
	size_t n_intervals = 0;
	value_type g, m, kT, kQ, d, IM;
	value_type Iges[3] = {0, 0, 0};
	...
	solver::TestIntegratorRosenbrock(n_intervals, g, m, kT, kQ, d, IM, Iges);
}
*/